...
<div class="product-middle">
    <div class="fit-top">
        <h6 class="shop-top"><?= $product['name']?></h6>
...
<div class="product-bottom">
    ...
    <div class="product-go">
        ...
        <div class=" fashion-grid1">
            <h6 class="best2"><a href="#" > Name</a></h6>

            <span class=" price-in1"> <?= $product['name']?></span>
        </div>
        <div class=" fashion-grid1">
            <h6 class="best2"><a href="#" > Price</a></h6>

            <span class=" price-in1"> <?= $product['price']?></span>
        </div>
        <div class=" fashion-grid1">
            <h6 class="best2"><a href="#" > Description</a></h6>

            <span class=" price-in1"> <?= $product['description']?></span>
        </div>
        <div class=" fashion-grid1">
            <h6 class="best2"><a href="#" > Category</a></h6>

            <span class=" price-in1"> $<?= $product['category_id']?></span>
        </div>
...
<?php if($product['discount'] !== NULL || $product['discount'] !== 0 || $product['discount'] !== false){?>
<div class=" per1">
        <div class="six1">
            <h4>DISCOUNT</h>
