        ...
        <div class="content-top">
            ...
            <div class="grid-in">
                <div class="col-md-4 grid-top">
                    <a href="../views/single.php" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive"
                    ...
                    <p><a href="../views/single.php">Contrary to popular</a></p>
                </div>
                <div class="col-md-4 grid-top">
                    <a href="../views/single.php" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive"
                    ...
                    <p><a href="../views/single.php">classical Latin</a></p>
                </div>
                <div class="col-md-4 grid-top">
                    <a href="../views/single.php" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive"
                    ...
                    <p><a href="../views/single.php">undoubtable</a></p>
                </div>
            ...
            <div class="grid-in">
                <div class="col-md-4 grid-top">
                    ...
                    <p><a href="../views/single.php">suffered alteration</a></p>
                </div>
                <div class="col-md-4 grid-top">
                    <a href="../views/single.php" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive"
                    ...
                    <p><a href="../views/single.php">Content here</a></p>
                </div>
                <div class="col-md-4 grid-top">
                    <a href="../views/single.php" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive"
                    ...
                    <p><a href="../views/single.php">readable content</a></p>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
